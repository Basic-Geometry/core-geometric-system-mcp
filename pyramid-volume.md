# The volume of a pyramid can be calculated as a cone with a polygonal base.

A pyramid can be calculated with the same formula as a cone : V = base × height / √8
...
Thus, the conventional base × height / 3 formula, and its so-called "calculus-based proofs" are invalid.
